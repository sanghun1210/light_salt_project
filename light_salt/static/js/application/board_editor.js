 	...
 	tinyMCE.init({ 
		...
		menubar : false,
		statusbar: false,
		plugins: 'fileupload image imagetools autoresize print preview paste searchreplace autolink directionality visualblocks visualchars fullscreen link table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists textcolor contextmenu colorpicker textpattern',
