...
class LSCH003M(models.Model):
    ...
    file_attach_yn = models.CharField(max_length=10, null=False, default="Y")
    comment_use_yn = models.CharField(max_length=10, null=False, default="Y")
    webedit_use_yn = models.CharField(max_length=10, null=False, default="Y")
    passwd_use_yn = models.CharField(max_length=10, null=False, default="N")
    new_icon_terms = models.IntegerField(null=False, default=2)
    hot_icon_view_count = models.IntegerField(null=False, default=1000)
    image_width = models.IntegerField(null=False, default=180)
    image_height = models.IntegerField(null=False, default=200)
    image_br_count = models.IntegerField(null=False, default=4)
    create_time = models.DateTimeField(auto_now_add=True, null=False)
    modify_time = models.DateTimeField(auto_now=True, null=False)
    user_id = models.CharField(max_length=20, null=False)
